...
contract sSax is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Token Staked SaxAO", "sSax", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSax supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSax
